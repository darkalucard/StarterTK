...
int classdb_read(const char *classdb_file) {
	...
	if(SQL_ERROR == SqlStmt_Prepare(stmt, "SELECT `PthId`, `PthType`, `PthChat`, `PthIcon`, `PthMark0`, `PthMark1`, `PthMark2`, `PthMark3`,"
		"`PthMark4`, `PthMark5`, `PthMark6`, `PthMark7`, `PthMark8`, `PthMark9`, `PthMark10`, `PthMark11`, `PthMark12`, `PthMark13`, `PthMark14`, `PthMark15` FROM `Paths`")
