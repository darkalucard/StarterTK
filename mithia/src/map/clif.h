...
float clif_battle_values(USER*,MOB*,float);
...
int clif_handle_bfp(USER*,int,float);
...
int clif_sendminitext(USER*,char*,int);
int clif_sendwisp(USER*,char*,unsigned char*,int);
int clif_retrwisp(USER*,char*,unsigned char*,int);
int clif_failwisp(USER*);
int clif_sendsay(USER*,char*,int,int);
int clif_sendmsg(USER*,int,char*,int);
...
int clif_broadcastsd(char*,int,USER*);
...
int pc_damage(USER*, USER*);
int clif_updatestate(struct block_list*,va_list);
int clif_sendtowns(USER*,int);
...
int clif_mapselect(USER *,char*,int*,int*,char**,int*, int*, int* , int );
